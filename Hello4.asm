; ===== JOGO DO DINOSSAURO 2.1 (FIX JGE) =====
jmp main
...
; --- SISTEMA DE CACTOS ---
; 0 = Inativo, >0 = Posicao na tela
cacto1_pos: var #1
static cacto1_pos + #0, #0
cacto1_pos_ant: var #1
static cacto1_pos_ant + #0, #0
cacto1_tipo: var #1    ; 0=Facil, 1=Medio, 2=Dificil
...
; Controle de Spawning
timer_spawn: var #1
static timer_spawn + #0, #5    ; Começa quase pronto para spawnar
proximo_tipo: var #1
static proximo_tipo + #0, #0   ; Alterna 0, 1, 2
...
velocidade: var #1
static velocidade + #0, #40    ; Começa mais lento (mais facil)
contador_vel: var #1
...
loop_principal:
    call atualiza_dino
    call verifica_tecla
    call gerencia_cactos  ; Nova funcao que move e cria cactos
...
verifica_tecla:
    ...
    ; Força do pulo ajustada para 5 (bom equilibrio)
    loadn r0, #3
    store dino_vel_y, r0
    loadn r0, #0
    store dino_no_chao, r0
...
; ===== GERENCIA CACTOS (MOVER E SPAWNAR) =====
gerencia_cactos:
    push r0
    push r1
    push r2
...
tenta_spawnar:
    ...
    ; Nenhum slot livre? Reseta timer curto pra tentar logo
    loadn r0, #5
    store timer_spawn, r0
    jmp gerencia_cactos_fim

nascer_cacto1:
    loadn r0, #1119 ; Nasce na direita
    store cacto1_pos, r0
    store cacto1_pos_ant, r0 ; Pra nao apagar errado
...
define_tipo_e_reset:
    ...
    ; Aumentei para 65 para dar bastante espaco
    loadn r1, #65
...
try_tipo1:
    ...
    rts
try_tipo2:
    ; Tipo 2 (Dificil): '#' vermelho
    loadn r1, #'#'
    loadn r2, #2304
    add r1, r1, r2
    rts

; ===== OUTRAS SUBROTINAS (MANTIDAS) =====
desenha_cenario:
    push r0
    push r1
    push r2
